...
export const textareaStyles = {
  ...
  textarea: cva(
    [
      "w-full rounded-default border bg-surface-default text-text-primary transition-colors resize-y min-h-[80px]",
      "placeholder:text-text-muted",
      "focus:outline-none focus:ring-2 focus:ring-interactive-accent/20 focus:border-interactive-accent",
      "data-[disabled]:cursor-not-allowed data-[disabled]:bg-surface-muted data-[disabled]:text-text-muted data-[disabled]:border-border-default data-[disabled]:resize-none",
    ],
    {
      variants: {
        size: {
