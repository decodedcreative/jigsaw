...
export const tabStyles = {
  tab: cva(
    [
      "px-4 py-2 text-sm font-medium transition-colors outline-hidden",
      ...
      variants: {
        variant: {
          ...
          pills: [
            ...
            "data-selected:bg-surface-primary data-selected:text-foreground-primary data-selected:shadow-2xs",
          ],
        },
      },
