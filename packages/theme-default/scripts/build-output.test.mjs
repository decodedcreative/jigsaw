...
test("semantic CSS files use the same selectors as the former @jigsaw/tokens build", () => {
  ...
  assert.match(light, /--color-surface-primary:/);
  assert.match(dark, /--color-surface-primary:/);
});
