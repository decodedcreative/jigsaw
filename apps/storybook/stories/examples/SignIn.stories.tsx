    ...
    return (
      <div className="min-h-screen bg-surface-default flex items-center justify-center p-6">
        <Card className="w-full max-w-sm p-8 text-center shadow-lg">
          ...
          <Text variant="heading-md" className="mb-2">Signed in!</Text>
          <Text variant="body-sm" className="text-text-secondary mb-6">Welcome back to Jigsaw.</Text>
    ...
    <div className="min-h-screen bg-surface-default flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <Text variant="heading-lg" as="h1">Sign in to Jigsaw</Text>
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <Text variant="caption" className="text-text-muted">or continue with</Text>
          <div className="flex-1 h-px bg-border-subtle" />
        </div>
