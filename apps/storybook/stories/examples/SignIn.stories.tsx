    ...
    return (
      <div className="min-h-screen bg-surface-default flex items-center justify-center p-6">
        <Card className="w-full max-w-sm p-8 text-center shadow-lg">
          <div className="w-12 h-12 rounded-full bg-feedback-success-subtle flex items-center justify-center mx-auto mb-4">
            <svg className="w-6 h-6 text-feedback-success" viewBox="0 0 24 24" fill="none">
              <path d="M5 13l4 4L19 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          <H2 classNameOverrides={{ component: ["mb-2"] }}>Signed in!</H2>
          <Text variant="body-sm" className="text-foreground-secondary mb-6">Welcome back to Jigsaw.</Text>
          <Button onPress={() => setSubmitted(false)}>Sign out</Button>
        </Card>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-surface-default flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <H1 size="h2">Sign in to Jigsaw</H1>
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <Text variant="caption" className="text-foreground-muted">or continue with</Text>
          <div className="flex-1 h-px bg-border-subtle" />
        </div>
