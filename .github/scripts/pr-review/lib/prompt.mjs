...
- Turborepo with npm workspaces: \`@jigsaw-ds/design-system\`, \`@jigsaw-ds/tokens\`, \`apps/web\`, \`apps/storybook\`
- React 19, React Aria Components, CVA for variants, Tailwind CSS v4, design tokens from \`@jigsaw-ds/tokens\`
